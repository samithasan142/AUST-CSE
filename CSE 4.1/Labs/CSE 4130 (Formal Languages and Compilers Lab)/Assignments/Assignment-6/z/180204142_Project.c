...
void ID()
{
    ...
    if(cgf[in] == 'a' || cgf[in] == 'b' || cgf[in] == 'c' || cgf[in] == 'd' || cgf[in] == 'e')
    {
        in++;
        fl = 1;
        return;
...
void relop()
{
    ...
    if((cgf[in] == '=' && cgf[in+1] == '=') ||
            (cgf[in] == '!' && cgf[in+1] == '=')  || (cgf[in] == '<' && cgf[in+1] == '=') ||
            (cgf[in] == '>' && cgf[in+1] == '='))
    {
        in+=2;
        fl = 1;
...
void dscn_stat()
{
    ...
    if(cgf[in] == 'i' && cgf[in+1] == 'f' && cgf[in+2] == '(')
    {
        in += 3;
        fl = 1;
        if(fl == 1)
...
void extn1()
{
    ...
    if(cgf[in] == 'e' && cgf[in+1] == 'l' && cgf[in+2] == 's' && cgf[in+3] == 'e')
    {
        in+=4;
        fl = 1;
        if(fl == 1)
...
void loop_stat()
{
    ...
    if(cgf[in] == 'w' && cgf[in+1] == 'h' && cgf[in+2] == 'i' && cgf[in+3] == 'l'
            && cgf[in+4] == 'e' && cgf[in+5] == '(')
    {
        in += 6;
        fl = 1;
    ...
    if(cgf[in] == 'f' && cgf[in+1] == 'o' && cgf[in+2] == 'r' && cgf[in+3] == '(')
    {
        in += 4;
        fl = 1;
        if(fl == 1)
